...
export const ALL_TESTS: ({ kind: 'quiz' } | ({ kind: 'calculator' } & CalculatorTest))[] = [
  ...
  } as any,
  {
    ...
    id: 'zodiac-match',
    title: 'Zodiac Match',
    description: 'Read the stars for astrological alignment',
    duration: '1 min',
    icon: 'planet-outline',
  ...
  },
  {
    ...
    description: 'Decode cosmic timing from birth dates',
    duration: '1 min',
  ...
  },
  {
    ...
    id: 'numerology-match',
    title: 'Numerology',
    description: 'Uncover harmony through sacred numbers',
    duration: '2 min',
  ...
  },
  {
    ...
    id: 'love-score',
    title: 'Love Score',
    description: 'Measure the spark between two names',
    duration: '1 min',
    icon: 'pulse-outline',
